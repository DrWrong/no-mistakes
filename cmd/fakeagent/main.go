// fakeagent is a deterministic stand-in for the real Claude, Codex, TraeX,
// and OpenCode CLIs used by no-mistakes' e2e tests. One binary is compiled and
...
func run(argv []string) int {
	...
	case "traex":
		return runTraex(args, os.Stdin, scenario)
	case "opencode":
